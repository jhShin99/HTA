...
<div class="container">
  <form action="replyAction" method="post" name="boardform">
    ...
    <div class="form-group">
      ...
      <textarea name="BOARD_SUBJECT" id="board_subject" maxlength="100" rows="1" class="form-control">Re:${boarddata.BOARD_SUBJECT}</textarea>
    </div>
    <div class="form-group">
      <label for="board_content">내용</label>
      <textarea name="BOARD_CONTENT" id="board_content" rows="15" class="form-control"></textarea>
    </div>
    <div class="form-group">
