...
public class TreeSet3_Person1 {
    ...
    public static void main(String[] args) {
        ...
        //객체 생성
        //Comparable 구현으로 에러 없이 잘 동작되는 모습
        treeSet.add(new Person1("홍길동", 30));
        treeSet.add(new Person1("자바", 26));
        treeSet.add(new Person1("스프링", 26));
        treeSet.add(new Person1("홍길동", 35));
