...
public class MemberDao_설명 {
     ...
     * <p>
     * 4) mybatis 설정 파일 : 데이터베이스 연결 정보, 트랜잭션 정보,
     * mybatis 제어 정보 등의 설정 내용을 포함하고 있습니다.
     * SqlSessionFactory를 만들 때 사용됩니다.
     * <p>
     * 5) SQL 매퍼 파일 : SQL문을 담고 있는 파일로 SqlSession 객체가 참조합니다.
     * <p>
     * SqlSession의 주요 메서드
     ...
     * <p>
     * 3) insert() : insert문을 실행합니다. 반환값은 입력한 로우 개수입니다.
     * <p>
     * 4) update() : update문을 실행합니다. 반환값은 변경한 로우 개수입니다.
     * <p>
     * 5) delete() : delete문을 실행합니다. 반환값은 삭제한 로우 개수입니다.
     */
    ...
    public int chk(Member member) {
        ...
        try (SqlSession session = getSession()) {
             ...
             * SQL 매퍼 파일에서 namespace가 "org.hta.mybatis.member"이고
